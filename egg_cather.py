...
egg_color = cycle(['yellow', 'dark blue', 'red', 'pink', 'light green'])
egg_wight = 85
egg_height = 100
egg_score = 10
egg_speed = 500
...
def create_egg():
    x = randrange(10, 740)
    y = 10
    new_egg = c.create_oval(x, y, x + egg_wight, y + egg_height, fill=next(egg_color), width=0)
    eggs.append(new_egg)
...
def check_catсh():
    ...
    root.after(100, check_catсh)


def increase_score(points):
    global score, egg_speed, egg_interval
    score += points
    egg_speed = int(egg_speed * difficylti_factor)
    egg_interval = int(egg_interval * difficylti_factor)
