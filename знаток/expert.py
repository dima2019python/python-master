...
def read_from_file():
    with open('/home/aydorovs/Рабочий стол/знаток/capital_data.txt',encoding='utf-8') as file:
        for line in file:
            line = line.rstrip('\n')
...
def write_to_file(country_name, city_name):
    with open('/home/aydorovs/Рабочий стол/знаток/capital_data.txt', 'a', encoding='utf=8') as file:
